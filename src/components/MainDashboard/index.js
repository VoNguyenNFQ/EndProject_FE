              ...
              >
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap">
                    ...
                    >
                      <h5
                        className="text-gray-400 uppercase font-bold text-xs"
                      >
                        Traffic
                      </h5>
        ...
        <div className='mx-auto max-w-full'>
          <div className='grid grid-cols-1 xl:grid-cols-6'>
            <div className='xl:col-start-1 xl:col-end-5 px-4 mb-16'>
              <div
                className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-gray-700"
              >
                <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div className="flex flex-wrap items-center">
                    <div className="relative w-full max-w-full flex-grow flex-1">
                      <h6
                        className="uppercase text-gray-100 mb-1 text-xs font-semibold"
                      >
                        Overview
                      </h6>
              ...
              >
                <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div className="flex flex-wrap items-center">
                    <div className="relative w-full max-w-full flex-grow flex-1">
                      <h6
                        className="uppercase text-gray-400 mb-1 text-xs font-semibold"
                      >
                        Performance
                      </h6>
