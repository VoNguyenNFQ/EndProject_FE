...
const AlertModal = ({ show, setShow }) => {
    ...
    return (
        <>
            {
                show &&
                <div id="popup-modal" tabIndex="-1" class="overflow-y-auto flex items-center justify-center overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 bg-overlay h-modal md:h-full">
