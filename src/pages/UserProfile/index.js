                    ...
                    <div class="flex flex-wrap justify-start p-10">
                        <div class="w-full lg:w-2/6 px-4 flex flex-col items-center justify-start">
                            ...
                            <div className='flex flex-row items-center justify-center mb-2 mt-5'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"                                     onClick={() => {setActive(1); setShowChangePassword(false);setShowPendingOrder(false); setShowEditInfo(true) }}>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </div>
                            <div> 
                                <p class="text-base font-semibold leading-normal  text-blueGray-700 mr-2 text-center">
                                    {userInfo.email}
                                </p>
                            </div>
