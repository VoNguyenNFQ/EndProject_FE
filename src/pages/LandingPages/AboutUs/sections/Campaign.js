            ...
            <div class="p-5 bg-white">
                ...
                <div class="container m-auto px-6 space-y-8 text-gray-500 md:px-12 lg:px-20">
                    <div class="justify-center text-center gap-6 md:text-left md:flex lg:items-center  lg:gap-16">
                        ...
                        <h1 class="text-4xl text-gray-700 font-bold md:text-5xl">Sale up to <span class="text-pink-500">30% off</span></h1>
                            ...
                            <div class="flex flex-row-reverse flex-wrap justify-center gap-4 md:gap-6 md:justify-end">
                                <button type="button" title="Start buying" class="w-full py-3 px-6 text-center rounded-xl transition bg-pink-400 shadow-xl hover:bg-pink-400 active:bg-gray-700 focus:bg-gray-600 sm:w-max">
