...
const SignUp = () => {
    ...
    return (
        <div>
            <div className="bg-signupbg bg-cover lg:py-12 lg:flex lg:justify-center sm:px-6 px-6 lg:px-1 md:px-1 md:py-12 py-9 2xl:mx-auto">
                <div className='bg-white mx-8 lg:mx-8 lg:flex lg:drop-shadow-xl lg:rounded-lg'>
                    <div className="bg-white w-full p-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <div className="mt-2w-full mb-2 w-2/3">
