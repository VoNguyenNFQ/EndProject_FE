...
const SignUp = () => {
    ...
    return (
        <div>
            <div className="bg-signup bg-contain lg:py-12 lg:flex lg:justify-center sm:px-6 px-6 lg:px-1 md:px-1 md:py-12 py-9 2xl:mx-auto">
                <div className='bg-white lg:mx-8 lg:flex lg:shadow-lg lg:rounded-lg'>
                    <div className="bg-white w-full rounded lg:px-10 sm:px-6 sm:py-10 px-5 py-10">
                        <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 mb-2">
                            Sign up
                        </p>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mt-2w-full">
                        ...
                        <div className="mt-2w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input id="myInput" type={showPass ? "text" : "password"} className="border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                                <div onClick={() => setShowPass(!showPass)} className="absolute right-0 mt-2 mr-3 cursor-pointer">
                                        {showPass ? <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        <div className="mt-2w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input id="myInput" type={showRePass ? "text" : "password"} className="border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                                <div onClick={() => setShowRePass(!showRePass)} className="absolute right-0 mt-2 mr-3 cursor-pointer">
                        ...
                        <div className="mt-8 flex justify-center item-center">
                            <button type="submit" className=" text-sm font-semibold leading-none text-white focus:outline-none bg-pink-400 rounded hover:bg-pink-500 py-4 w-1/2">
                                Create my account
                            </button>
                        </div>
                    </form>
                        <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                            Have account?{" "}
                            <Link to="/pages/authentication/sign-in" className="hover:text-pink-600 focus:outline-none text-sm font-medium leading-none text-pink-400 cursor-pointer">
                                {" "}
                                Sign in here
                            </Link>
                        </p>
                    ...
                    <div className="w-full hidden lg:block">
                        <div className="flex items-start ">
                            <img src={signup} className="object-contain h-full" />
                        </div>
                    </div>
                </div>
            </div>
